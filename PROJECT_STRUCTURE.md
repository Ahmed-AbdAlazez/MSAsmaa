...
├── dashboard-student.html      # لوحة تحكم الطالب
...
3. **لوحة تحكم الطالب (`dashboard-student.html`)**: نسبة التقدم، الواجبات، البانل
   المخصص للاختبارات المُرْسلة، والإشعارات.
