  ...
  const openTeamModal = () => {
    ...
    const socials = (name) => `
      <div class="team-socials">
        ...
        <a href="https://wa.me/${accounts[name].wa}" class="team-social team-social-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="واتساب · ${name}" title="واتساب">${whatsappIcon}</a>
      </div>`;
    ...
    const card = (name) => `
      <article class="team-card">
        ...
        <h4>${name}</h4>
        <a class="team-phone" href="https://wa.me/${accounts[name].wa}" target="_blank" rel="noopener noreferrer" aria-label="واتساب · ${name}" title="تواصل عبر واتساب">${accounts[name].phone}</a>
        ${socials(name)}
      </article>`;
